...
void stealthim_loop_call_soon(loop_t *loop, loop_cb_t cb, void *userdata); // caller is loop thread ok
void stealthim_loop_post(loop_t *loop, loop_cb_t cb, void *userdata); // thread-safe
